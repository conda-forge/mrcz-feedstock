About mrcz-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mrcz-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/em-MRCZ/python-mrcz

Documentation: http://python-mrcz.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6137&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mrcz-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mrcz` can be installed with `conda`:
...
It is possible to list all of the versions of `mrcz` available on your platform with `conda`:
...
```
mamba search mrcz --channel conda-forge
```
...
mamba repoquery search mrcz --channel conda-forge

# List packages depending on `mrcz`:
mamba repoquery whoneeds mrcz --channel conda-forge

# List dependencies of `mrcz`:
mamba repoquery depends mrcz --channel conda-forge
```
